...
Skills are invoked by slash command: `/hy-skills:go`, `/hy-skills:my-simplify`, `/hy-skills:refactor`, `/hy-skills:open-worktree`, `/hy-skills:commit-push-pr`, `/hy-skills:loop-for-merge`, `/hy-skills:close-worktree`, `/hy-skills:prototype-board`, `/hy-skills:goal-shaper`, `/hy-skills:gdd`, `/hy-skills:explain`, `/hy-skills:html-as-doc`, `/hy-skills:infisical-secrets`, `/hy-skills:use-portless`.
...
v0.1.0. Dogfooded across many projects on task kickoff, feature delivery, simplification/refactor review, PR publishing, happy-path merge watching, finished-task closeout, feel-first prototype board construction, section-by-section goal document shaping, single-file HTML-as-doc authoring, Infisical-backed local env staging, and Portless-backed dev server URL workflows. Active iteration — expect rules to change as more dogfood data comes in.
